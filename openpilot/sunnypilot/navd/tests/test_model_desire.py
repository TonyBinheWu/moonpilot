...
@pytest.mark.parametrize(("maneuver_type", "modifier", "expected"), [
...
def test_maneuver_mapping(maneuver_type, modifier, expected):
  assert maneuver_to_desire(maneuver_type, modifier) == expected


def test_activation_distance_scales_and_is_bounded():
